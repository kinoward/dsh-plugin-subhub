...
import { registerAlibaba, registerMinimax, registerOpenRouter, registerVolcengine } from "./providers/api-key.js";
...
function apply(ctx, config) {
	...
	registerVolcengine(ctx, config);
	registerAlibaba(ctx, config);
	registerMinimax(ctx, config);
	registerOpenRouter(ctx, config);
}
//#endregion
export { CHATGPT_BACKEND_BASE_URL, OpenAIAdapter, OpenAITokenStore, Config, DEFAULT_CONTEXT_WINDOW, DEFAULT_MODELS, OPENAI_API_BASE_URL, PROVIDER, REASONING_EFFORTS, apply, applyDelegationDirective, applyImageGenerationDirective, inject, latestConversationImageRef, name, registerAlibaba, registerAnthropic, registerGithub, registerGoogle, registerKimi, registerMinimax, registerOpenRouter, registerVolcengine, registerXai, resolveAdapterOptions };
